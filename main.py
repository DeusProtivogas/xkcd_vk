...
from vk_image_uploading import post_image_to_vk_group_wall
...
def main():
    ...
    comic_url, comic_name = get_random_url_filename()

    try:
        message = get_random_comic(comic_url, comic_name)
